            ...
            <nav class="collapse position-absolute navbar navbar-vertical navbar-light align-items-start p-0 border border-top-0 border-bottom-0 bg-light" id="navbar-vertical" style="width: calc(100% - 30px); z-index: 9;">
                <div class="navbar-nav w-100">
                    <div class="nav-item dropdown">
                        <a href="ListFacultys" class="nav-item nav-link">List of Facultys</a>
                    </div>
                    <a href="ListStudents" class="nav-item nav-link">List of Students</a>
                    	
                    <a href="adminchangepassword" class="nav-item nav-link">Settings</a>
                </div>
            </nav>
        </div>
        <div class="col-lg-9">
                ...
                <div class="collapse navbar-collapse justify-content-between" id="navbarCollapse">
                 ...
                 <div class="nav-item dropdown">
                            ...
                            <div class="dropdown-menu rounded-0 m-0">
                                <a href="addFaculty" class="dropdown-item">Add Faculty</a>
                                <a href="addStudent" class="dropdown-item">Add Student</a>
                            </div>
                        </div>
                    <div class="navbar-nav py-0">
                       <!--   <a href="addFaculty" class="nav-item nav-link active">Add Faculty</a> -->
                      <!--    <a href="aupdate" name="aupdate" class="nav-item nav-link">Update</a> -->
                        <div class="nav-item dropdown">
                            <a href="#" class="nav-link dropdown-toggle" data-toggle="dropdown">Update</a>
                            <div class="dropdown-menu rounded-0 m-0">
                                <a href="updatefaculty" class="dropdown-item">Faculty</a>
                                <a href="updatestudent" class="dropdown-item">Student</a>
                            </div>
                        </div>
                        ...
                        <a href="viewallgrades" id="agrade"class="nav-item nav-link">All Grades</a>
                        <div class="nav-item dropdown">
                            <a href="#" id = "aremove"class="nav-link dropdown-toggle" data-toggle="dropdown">Remove</a>
                            <div class="dropdown-menu rounded-0 m-0">
                                <a href="removeFaculty" class="dropdown-item">Faculty</a>
                                <a href="removeStudent" class="dropdown-item">Student</a>
                            </div>
                        </div>
                    </div>
